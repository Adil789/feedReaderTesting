...
$(function() {
    ...
    describe('Initial Entries', function() {
        ...
        //test that there should be at least one entry in the feed.
...
//check the all files in the browser 
//check if errors are obtained or not
// if the errrors are found edit the app.js file 
